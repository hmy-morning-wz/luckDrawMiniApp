...
const HOST_BASE_URL ='https://ztmanage.allcitygo.com:8192'//'https://sit-basic-ug.allcitygo.com'// 'http://172.31.254.206:5002'// 'https://ztmanage.allcitygo.com:8192' // 'https://sit-basic-ug.allcitygo.com'
const APP_ID = '2019021563231625'
        ...
        try {
            my.request({
                ...
                fail: error => {
                    ...
                    let app = getApp()
                    app.Tracker && app.Tracker.err(url,{...error})
...
function getHeader(data = {}) {   
    ...
    let res = {
        ...
        'app_id': data.appId  || $global.appId || getApp().appId || APP_ID,
...
async function loadToken() {
    ...
    let now = +Date.now()
    if (res && res.success && res.data && res.data.success&&  res.data.expireTime > now) {
        let app = getApp()
